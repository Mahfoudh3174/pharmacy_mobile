...
class OrdersDelivredController extends GetxController {
  ...
  void onInit() {
    debugPrint("onInit");
    getDelivredOrdersData();
    super.onInit();
  }

  getDelivredOrdersData() async {
    try {
      statusRequest = StatusRequest.loading;
      update();

      var response = await orderData.getOrdersData(status: "LIVRÉ", page: 1);
