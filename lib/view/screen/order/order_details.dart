                      ...
                      child: Column(
                        children: [
                            ...
                            children: [
                              ...
                              ...List.generate(
                                  ...
                                  (index) => TableRow(children: [
                                        Text("${controller.order!.medications[index].name}",
                                            textAlign: TextAlign.center),
                                            Text("${controller.order!.medications[index].pivotQuantity}",
                                            textAlign: TextAlign.center),
                                        Text("${controller.order!.medications[index].totalPrice}", textAlign: TextAlign.center),
                          ...
                          Container(
                            ...
                            child:   Text("${'TotPrix'.tr}: ${controller.order!.totalAmount}\$",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    color: AppColor.primary,
                                    fontWeight: FontWeight.bold)),
